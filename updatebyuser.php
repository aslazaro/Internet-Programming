...
if(isset($_POST) & !empty($_POST)){
	...
	$UpdateSql = "UPDATE `guestuser` SET username='$username', first_name='$fname', last_name='$lname', email='$email', mobile_number='$mobile', Address='$address' WHERE User_ID=$id";
	$res = mysqli_query($conn, $UpdateSql);
	if($res){
		header('Location: userprofile.php?update=Profile is successfully updated.');
	}else{
